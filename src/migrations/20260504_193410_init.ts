...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_docs_section" AS ENUM('getting-started', 'templates', 'quotes', 'forms', 'leads', 'sharing', 'analytics', 'account', 'reference');
  CREATE TYPE "public"."enum_docs_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__docs_v_version_section" AS ENUM('getting-started', 'templates', 'quotes', 'forms', 'leads', 'sharing', 'analytics', 'account', 'reference');
  ...
  CREATE TABLE "_docs_v" (
  	...
  	"version_section" "enum__docs_v_version_section",
